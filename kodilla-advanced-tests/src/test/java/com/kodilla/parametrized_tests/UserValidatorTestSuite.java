...
class UserValidatorTestSuite {
    ...
    public void shouldReturnFalseIfStringIsNotWorkingWithRegex_validateUsernameMethod(String username) {
    ...
    public void shouldReturnTrueIfStringIsWorkingWithRegex_validateUsernameMethod(String username) {
        boolean result = userValidator.validateUsername(username);
        assertTrue(result);
    }
    ...
    public void shouldReturnFalseIfStringIsNotWorkingWithRegex_validateEmailMethod(String email) {
    ...
    public void shouldReturnTrueIfStringIsWorkingWithRegex_validateEmailMethod(String email) {
        boolean result = userValidator.validateEmail(email);
        assertTrue(result);
    }
}